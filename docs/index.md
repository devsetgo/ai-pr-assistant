...
1. Get an API key: create an account with OpenAI, set up a payment method and get your [OpenAI API key]
   ...
   [setup guide](SETUP.md#get-an-api-key) has step-by-step instructions for both.
...
- [**Model reference**](MODELS.md) — OpenAI and Claude models side by side (convenience only, with a
